...
function allLessonsComplete() {
  return lessons.every((lesson) => isLessonDone(lesson.id));
}
...
function checkUnlocks() {
  const completed = allLessonsComplete();

  quizBtn.disabled = !completed;
  ...
  if (completed) {
    ...
    quizBtn.textContent = "Complete all lessons first";
